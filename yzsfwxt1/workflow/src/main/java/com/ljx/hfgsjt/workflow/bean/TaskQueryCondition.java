package com.ljx.hfgsjt.workflow.bean;

import com.ljx.hfgsjt.util.exception.OneBaseException;
import com.ljx.hfgsjt.util.http.bean.BaseQueryCondition;
...
import com.ljx.hfgsjt.workflow.bean.constant.FlowQueryTypeEnum;
