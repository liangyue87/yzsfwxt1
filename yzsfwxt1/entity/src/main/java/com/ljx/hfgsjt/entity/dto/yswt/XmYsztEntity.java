...
public class XmYsztEntity {
  ...
  private String xmdz;
  private String dwmc;
  private java.sql.Date slsj;
  private String iszj;//直建项目
  private String lxdh;
  ...
  private java.sql.Date jhkssj;
  private java.sql.Date jhjssj;
  ...
  private String yszt; //预算状态0 是待办 1 是结办
  private String htyy;//回退原因
  private String taskid;//任务id
  private String bjzt;//办结状态
  ...
  public java.sql.Date getSlsj() {
    return slsj;
  }

  public void setSlsj(java.sql.Date slsj) {
    this.slsj = slsj;
  }
  ...
  public java.sql.Date getJhkssj() {
    return jhkssj;
  }

  public void setJhkssj(java.sql.Date jhkssj) {
    this.jhkssj = jhkssj;
  }


  public java.sql.Date getJhjssj() {
    return jhjssj;
  }

  public void setJhjssj(java.sql.Date jhjssj) {
    this.jhjssj = jhjssj;
  }
