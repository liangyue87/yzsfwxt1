...
@Entity
@Table(name = "V_YSZJQTFK")
public class YsZjqtFkEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        YsZjqtFkEntity that = (YsZjqtFkEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, pxmbh, xmbh, sqlx, azlx, slid, sqbh, xmlb, xmtzf, xmswlxfl, qbid, status, slrbh, lxsj, xmfzr, xmmc, lxr, lxrsjh, xmdz, dwmc, slsj, iszj, lxdh, xzqybh, zjzmj, sjfzr, stfzr, jlfzr, zjfzr, ysfzr, qsfzr, sgfzr, bz, bmbmQs, jhkssj, jhjssj, xmdzSheng, xmdzShi, xmdzXzqybh, slsjStr, first, procStatus, pdefId,refkey,refid);
    }
}
