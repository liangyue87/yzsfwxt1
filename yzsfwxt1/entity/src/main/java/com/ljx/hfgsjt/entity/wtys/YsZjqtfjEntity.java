...
@Entity
@Table(name = "YS_ZJQTFJ")
public class YsZjqtfjEntity {
    private String id;
    private String yszjqtid;
    ...
    @Basic
    @Column(name = "YSZJQTID")
    public String getYszjqtid() {
        return yszjqtid;
    }

    public void setYszjqtid(String yszjqtid) {
        this.yszjqtid = yszjqtid;
    }
    ...
    public boolean equals(Object o) {
        ...
        YsZjqtfjEntity that = (YsZjqtfjEntity) o;
        return Objects.equals(id, that.id) &&
                Objects.equals(yszjqtid, that.yszjqtid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, yszjqtid, fjlxYj, fjlxEj, fjlj, fjhz, fjmc, scr, scsj, scFlag, shcr, shcsj);
    }
}
