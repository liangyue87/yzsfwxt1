                ...
                <el-card class="box-card">
                    ...
                    <div v-if="type == '1'">
                        <el-table :data="zlrow"  :stripe="true" style="width: 100%;" row-key="id" >
                            <el-table-column prop="codename" label="资料类型"  align="left" >
                                <template slot-scope="scope">
                                    <span style="font-size: 16px" v-if="scope.row.parentid==''||scope.row.parentid==null||scope.row.parentid==undefined">{{scope.row.codename}}</span>
                            ...
                            <el-table-column label="操作" align="center" >
                                <template slot-scope="scope" v-if="scope.row.parentid!=''&&scope.row.parentid!=null&&scope.row.count>0">
                                    <el-row>
                                        <el-col :span="24">
...
<script>
    ...
    import {getZlzl, toDetial, download_sjst} from '../../api/sjst';
