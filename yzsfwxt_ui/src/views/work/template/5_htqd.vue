...
<script>
    ...
    import {getAllInstInfo,queryHtbz} from '../../../api/work'
    ...
    export default {
        ...
        methods: {
            ...
            initView() {
                let html = "";
                html = '<div class="window rank_three line_three " id="50001">合同签订</div>';
                                ...
                                if(id == '#50001'){
                                    ...
                                    $(id).click(function () {
                                        ...
                                        queryHtbz(params).then(res=>{
                                            if(res.isEdit == 0){
                                                _this.$router.push({path: '/Htck', query: {xmid:_this.$route.query.xmid,ishx:'1'}})
                                            }else{
                                                _this.$router.push({path: '/Htck', query: {xmid:_this.$route.query.xmid,ishx:'1',
                                                        isEdit:"1",ehtzbid:res.list[0].ID}})
                                            }
                                        });
                                    });
                                }
            ...
            initFloatPenal(){
                ...
                $('.window').on('mouseenter', function (event) {
                    ...
                    let content = "<div style='height:60px'>"
