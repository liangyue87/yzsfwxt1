        ...
        <el-row>
            ...
            <el-col :span="24" class="toolbar" style="border: #f5f7fa solid 1px">
                <el-form  :model="filters"  style="margin-top: 10px">
                    <el-form-item>
                        ...
                        <el-col :span="5">
                            <el-input v-model="filters.xmmc" size="small "></el-input>
                        </el-col>
                ...
                <!--    <el-form-item>
                      &lt;!&ndash;  <el-col :span="2" style="text-align: right">
                            <span>用户联系人 &nbsp;</span>
                        </el-col>
                        <el-col :span="5">
            ...
            <el-col :span="24" class="toolbar" >
                ...
                <el-table :data="row"  v-loading="listLoading" style="width: 100%;" height="500px"  :row-style="rowClass" :header-cell-style="{fontSize:'15px',background:'#f5f7fa' }">
                    <el-table-column prop="xmbh" label="项目编号/申请编号" width="200" align="center">
                    </el-table-column>
                  ...
                  <!--  <el-table-column prop="status" label="项目状态" width="150" :formatter="formatStatus"  align="center">
                    ...
                    <el-table-column prop="codename" label="安装类型" align="center">
                    </el-table-column>
                    <el-table-column prop="lxr" label="用户联系人"  align="center">
                    </el-table-column>
                    <el-table-column prop="slsj_str" label="受理日期" align="center" >
                    </el-table-column>
                    <el-table-column prop="lxrsjh" label="联系电话" align="center">
                    </el-table-column>
                    <!--<el-table-column prop="xmdz" label="工程地址" width="200" align="center">
                    </el-table-column>-->
             <!--       <el-table-column prop="xmdz_Xzqybh" label="报建单位" width="150" align="center">
                     </el-table-column>-->
                    <el-table-column label="操作" width="150" align="center" fixed="right">
                        <template slot-scope="scope">
                            <label title="项目流程图" @click="handleEdit(scope.$index, scope.row)">
                                <i class="iconfont icon-tiaocha" style="cursor:pointer;padding: 2px;color: #66b1ff"></i></label>
                            <!--<el-button size="small" type="primary">发起管网信息</el-button>-->
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
    ...
    export default {
        ...
        methods:{
            ...
            handleEdit: function (index, row) {
                this.$router.push({path: '/Xmlct',query: {xmid:row.id,type:row.type,xmmc:row.xmmc}});
