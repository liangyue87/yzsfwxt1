	...
	<section>
		<el-form  :model="fmdzjForm"  >
			...
			<el-form-item>
				...
				<el-col :span="21">
					<el-input v-model="fmdzjForm.lm" size="small"></el-input>
				</el-col>
			</el-form-item>
			<el-form-item>
				<el-col :span="3" style="text-align: right">
				...
				<el-col :span="5">
					<el-input :readonly="true" v-model="fmdzjForm.fmbh" size="small"></el-input>
				</el-col>
				<el-col :span="4">
					<el-row>
						<el-col :span="12">
							<el-button type="primary" size="mini" style="margin-left: 5px;visibility:hidden;" @click="openFm()"><i class="iconfont icon-xuanze"></i>选择</el-button>
						</el-col>
			...
			<el-form-item>
				...
				<el-col :span="9">
					<el-date-picker value-format="yyyy-MM-dd" format="yyyy-MM-dd" type="date" size="small" readonly placeholder="选择日期" v-model="fmdzjForm.azrq_vue" style="width: 100%"></el-date-picker>
				</el-col>
				<el-col :span="3" style="text-align: right">
					<span>绘图人：</span>
				</el-col>
				<el-col :span="9">
					<el-input v-model="fmdzjForm.htr" readonly size="small"></el-input>
				</el-col>
			</el-form-item>
			<el-form-item>
				<el-col :span="3" style="text-align: right">
                ...
                <el-col :span="21">
                    <el-upload
                        ...
                        <el-button style="margin-left: 10px;display: none;" size="mini" type="success" @click="submitUpload" icon="el-icon-upload">上传</el-button>
                        <el-button size="mini" type="success" style="margin-left: 10px" @click="download"><i class="iconfont icon-xiazai"></i>下载</el-button>
