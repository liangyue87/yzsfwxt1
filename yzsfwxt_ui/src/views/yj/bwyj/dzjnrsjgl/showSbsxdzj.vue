<template>
	<section>
		<!--<el-dialog  title="阀门信息"  :visible.sync="fmDialogFormVisible" width="80%" :append-to-body="true">
				...
				<el-table-column  label="操作" align="center"width="150" fixed="right">
					<template slot-scope="scope">
						<el-button
								size="mini"
								type="primary"
								@click="chooseFm(scope.$index, scope.row)">选择</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-row>
		...
		<!--<el-dialog title="阀门信息录入"  :visible.sync="fmpzDialogFormVisible" width="50%" :append-to-body="true">
			<fmgl :id="fmid" :xmid="xmid"  @childConcer="closeFmDialog"></fmgl>
		</el-dialog>-->
		<!--<el-dialog title="选择水表信息" :visible.sync="SbDialogFormVisible" width="80%" :append-to-body="true">
				...
				<el-table-column  label="操作" align="center" fixed="right">
					<template slot-scope="scope">
						<el-button
								size="mini"
								type="primary"
								@click="chooseSb_vue(scope.$index, scope.row)">选择</el-button>
					</template>
				</el-table-column>
			...
			&lt;!&ndash;工具条&ndash;&gt;
			<el-row>
				<el-pagination layout="total, prev, pager, next"  @current-change="CurrentChange" :page-size="this.size" :total="this.total" style="float:right;">
				</el-pagination>
			</el-row>
		</el-dialog>-->
		<el-form  :model="sbsxdzjForm" >
			...
			<el-form-item>
				...
				<el-col :span="21">
					<el-input v-model="sbsxdzjForm.lm" readonly size="small"></el-input>
				</el-col>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-col :span="5">
					<el-input readonly v-model="sbsxdzjForm.sbbzh" size="small"></el-input>
				</el-col>
				<el-col :span="4">
					<el-row>
						<el-col :span="12">
			...
			<el-form-item>
				...
				<el-col :span="5">
					<el-input readonly v-model="sbsxdzjForm.bqfbh" size="small"></el-input>
				</el-col>
				<el-col :span="4">
					<el-row>
						<el-row>
							<el-col :span="12">
								<el-button style="margin-left:10px;visibility:hidden;" size="mini" type="primary" @click="fmxz_vue('1')"><i class="iconfont icon-xuanze"></i>选择</el-button>
							</el-col>
						</el-row>
					</el-row>
				</el-col>
				...
				<el-col :span="4">
					<el-input v-model="sbsxdzjForm.fbjjqf" readonly size="small"></el-input>
				</el-col>
				<el-col :span="3">mm</el-col>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-col :span="5">
					<el-input readonly v-model="sbsxdzjForm.bhfbh" size="small"></el-input>
				</el-col>
				<el-col :span="4">
					<el-row>
						<el-col :span="12">
							<el-button style="margin-left:10px;visibility:hidden;" size="mini" type="primary" @click="fmxz_vue('2')"  ><i class="iconfont icon-xuanze"></i>选择</el-button>
						</el-col>
					</el-row>
				</el-col>
				<el-col :span="5" style="text-align: right">
				...
				<el-col :span="4">
					<el-input v-model="sbsxdzjForm.fbjjhf" readonly size="small"></el-input>
				</el-col>
				<el-col :span="3">mm</el-col>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-col :span="9">
					<el-input v-model="sbsxdzjForm.htr" readonly size="small"></el-input>
				</el-col>
				<el-col :span="5" style="text-align: right">
					<span>安装日期：</span>
				</el-col>
				<el-col :span="7">
					<el-date-picker :editable="false" type="date" placeholder="选择日期" v-model="sbsxdzjForm.azrq_vue"
									readonly value-format="yyyy-MM-dd" format="yyyy-MM-dd" style="width: 100%"size="small"></el-date-picker>
				</el-col>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-col :span="21">
					<el-upload
							...
							:file-list="fileList"
							:auto-upload="false">
						<el-button slot="trigger" size="mini" type="success" icon="el-icon-tickets" style="display: none;">选择文件</el-button>
						<el-button style="margin-left: 10px;display: none;" size="mini" type="success" @click="" icon="el-icon-upload">上传</el-button>
						<el-button size="mini" type="success" style="margin-left: 10px" @click="download(0)"><i class="iconfont icon-xiazai"></i>下载</el-button>
