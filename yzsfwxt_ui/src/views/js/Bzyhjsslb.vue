        ...
        <el-row>
                ...
                <el-form  :model="filters" >
                    ...
                    <el-form-item>
                        ...
                        <el-col :span="3" style="text-align: center">
                            <el-button size="small" type="primary"  v-on:click="getHsjglr_vue"><i class="iconfont icon-chaxun"></i>查询</el-button>
            ...
            <el-col :span="24" class="toolbar" >
                ...
                <el-table :data="row"  v-loading="listLoading" style="width: 100%;" height="500px" :row-style="rowClass" :header-cell-style="{fontSize:'15px',background:'#f5f7fa' }">
                    ...
                    <el-table-column prop="azlx" label="安装类型" width="150" align="center">
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="150" align="center" fixed="right">
                        <template slot-scope="scope">
                            <label title="用户结算" @click="handleEdit(scope.$index, scope.row)">
                                <i class="iconfont icon-tiaocha" style="cursor:pointer;padding: 2px;color: #66b1ff"></i></label>
                     <!--       <el-button size="small" type="primary" @click="handleEdit(scope.$index, scope.row)"><i class="iconfont icon-tiaocha"></i>用户结算</el-button>-->
                            <!--<el-button size="small" type="primary" @click="handleEdit(scope.$index, scope.row)">用户结算</el-button>-->
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
...
<script>
    ...
    import{selectBzyhjssList}from'../../api/Js';
    export default {
        data(){
            return{
                filters:{
        ...
        methods:{
            ...
            getHsjglr_vue() {
                ...
                selectBzyhjssList(params).then((res) => {//
            ...
            handleEdit: function (index, row) {
                this.$router.push({path: '/Bzyhjsslbsj', query: {xmid : row.ID,sqlx:row.sqlx,sqbh:row.sqbh}})
            },
