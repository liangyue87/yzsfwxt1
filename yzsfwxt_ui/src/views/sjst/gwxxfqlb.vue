                ...
                <el-table :data="row"  v-loading="listLoading" style="width: 100%;"  height="500px" :row-style="rowClass" :header-cell-style="{fontSize:'15px',background:'#f5f7fa' }">
                    ...
                    <el-table-column label="操作" width="150" align="center" fixed="right">
                        <template slot-scope="scope">
                            <label title="管网信息反馈" @click="handleEdit(scope.$index, scope.row)">
                                <i class="iconfont icon-tiaocha" style="cursor:pointer;padding: 2px;color: #66b1ff"></i></label>
                           <!-- <el-button size="small" type="primary" @click="handleEdit(scope.$index, scope.row)">管网信息反馈</el-button>-->
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
...
<script>
    ...
    import{GetfqlbList}from'../../api/sjst';
    export default {
        data(){
            return{
                filters:{
        ...
        methods:{
            ...
            handleEdit: function (index, row) {
                ...
                this.$router.push({path: '/Gwxxfqlbsj',query: {xmid:row.id }});
