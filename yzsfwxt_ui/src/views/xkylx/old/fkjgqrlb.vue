				...
				<el-form  :model="filters" >
					...
					<el-form-item>
						...
						<el-col :span="3" style="text-align: center">
							<el-button type="primary" v-on:click="getKcfkYhqr">查询</el-button>
						</el-col>
					</el-form-item>
				</el-form>
			</el-col>
			...
			<el-table :data="row" border highlight-current-row v-loading="listLoading" style="width: 100%;">
				...
				<el-table-column label="操作" width="250" >
					<template slot-scope="scope">
						<el-button size="small" type="primary" @click="toFkjgqr(scope.$index, scope.row)">反馈结果确认</el-button>
					</template>
				</el-table-column>
			</el-table>
			</el-col>
...
<script>
	...
	import { getKcfkYhqr } from '../../../api/xkylx';
	export default {
		data() {
			return {
				filters: {
		...
		methods: {
			...
			//跳转至发起勘查任务界面
			toFkjgqr: function (index, row) {

				//setXmidToSession(params).then((res) =>{
					this.$router.push({path: '/Fkjgqr', query: {xmid : row.id}})
				//});
