			...
			<el-col :span="24">
				...
				<el-card class="box-card"  style="margin-top: 15px;">
					<div slot="header" class="clearfix">
						<div class="div_title">指派施工勘查人员</div>
					</div>
					<div class="text item">
						<!--可指派的人员-->
						<el-row>
				...
				<el-row style="margin-top: 25px;">
					<el-col :span="24" style="text-align: center">
						<el-button size="mini" type="info" @click="toRwlbsgdw">
							<i class="iconfont icon-quxiao"></i>取消
						</el-button>

						<el-button size="mini" type="primary" @click="taskZpSgdw" :loading="sumbitLoading">
