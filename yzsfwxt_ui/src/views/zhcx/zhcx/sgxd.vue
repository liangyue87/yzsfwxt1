        ...
        <el-row>
            ...
            <el-col :span="24" class="toolbar">
                <el-table id="out-table" :data="tableData" :span-method="objectSpanMethod" border highlight-current-row v-loading="listLoading"
                    ...
                    <el-table-column property="XMFZR" label="项目经理" width="125" align="center">
                    </el-table-column>
                    <el-table-column property="DWMC" label="报建单位" width="180" align="center">
                    </el-table-column>
                    <el-table-column property="SBS" label="水表总数" width="140" align="center">
                    </el-table-column>
                    <el-table-column property="RWBH" label="施工下单编号" width="180" align="center">
                    </el-table-column>
                    <el-table-column property="XDSJ" label="下单时间" width="180" align="center">
                    </el-table-column>
                    <el-table-column property="HBS" label="下单户表数" width="180" align="center">
                    </el-table-column>
                    <el-table-column property="DBS" label="下单工商表数" width="120" align="center">
                    </el-table-column>
                    <el-table-column property="GCNR_TY" label="庭院" width="180" align="center">
                    </el-table-column>
                    <el-table-column property="GCNR_BF" label="泵房" width="125" align="center">
                    </el-table-column>
                    <el-table-column property="GCNR_DG" label="吊管" width="120" align="center">
                    </el-table-column>
                    <el-table-column property="GCNR_LG" label="立管" width="180" align="center">
                    </el-table-column>
                </el-table>
            </el-col>
            <el-col :span="24" class="toolbar" >
...
<script>
    import { querysgxd } from '../../../api/sbyj';
