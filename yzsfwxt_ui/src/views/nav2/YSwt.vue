			...
			<el-form :inline="true" :model="YsForm">
				...
				<el-form-item label="项目状态"  >
					<el-select v-model="YsForm.status" placeholder="请选项目状态" @change="getList">
						...
						<el-option label="结办" value="1"></el-option>
					</el-select>
				</el-form-item>
...
<el-col :span="24" class="toolbar">
		...
		<el-table :data="yswt" fit style="width: 100%" highlight-current-row>
			<el-table-column fixed property="xmbh" label="项目编号" width="150"></el-table-column>
			<el-table-column label="项目状态" width="120">
				<template slot-scope="scope">
					<!--0是待办  1 是结办-->
					<span v-if="scope.row.yszt == '0' " style="color: #E64242;">待办</span>
					<span v-else style="color: #11B95C;">结办</span>
				</template>
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="100">
					<template slot-scope="scope">
						<!-- <el-button size="small" type="primary" @click.native="toFqlhkc">发起委托</el-button> -->
							<el-button size="small" type="primary" @click="toFqlhkc(scope.$index, scope.row)">发起委托</el-button>
								</template>
			</el-table-column>
