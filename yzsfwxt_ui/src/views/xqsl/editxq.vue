                    ...
                    <el-form :model="filters"  ref="filters" class="demo-ruleForm"><!--:rules="xqrules"-->
                        ...
                        <el-form-item>
                            <el-row>
                                ...
                                <el-col :span="5">
                                    <el-select v-model="filters.azlx" size="small" style="width:206px;" placeholder="请选择">
                            ...
                            <el-row>
                                ...
                                <el-col :span="5">
                                    <el-form-item prop="gcdz" :rules="this.publicUtil.notNull">
                                        <el-input v-model="filters.gcdz" size="small" style="width:557px;" placeholder="输入工程地址"></el-input>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                        </el-form-item>
                            ...
                            <el-row>
                                ...
                                <el-col :span="5">
                                    <el-form-item prop="gcmc" >
                                        <el-input v-model="filters.gcmc" size="small" style="width:206px;" placeholder="输入工程名称"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="2" style="text-align: right">
                                    <span>报建单位&nbsp;&nbsp;</span>
                                ...
                                <el-col :span="5">
                                    <el-input v-model="filters.bjdw" size="small" style="width:557px;" placeholder="输入报建单位"></el-input>
                                </el-col>
                            </el-row>
                        </el-form-item>
                        <el-form-item>
                            <el-row>
                               <!-- <div v-if="showHg">
                                ...
                                <el-col :span="5">
                                    <el-form-item><!--prop="zjlxdh" :rules="this.publicUtil.zjphone"-->
                        ...
                        <el-form-item v-if="showJm">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="zjzmj" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.zjzmj" size="small" style="width:206px;" placeholder="输入总建筑面积"></el-input>㎡
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>住宅面积&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-form-item prop="zzmj" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.zzmj" size="small" style="width:206px;" placeholder="输入住宅面积"></el-input>㎡
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>地块简称&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-input v-model="filters.dkjc" size="small" style="width:206px;" placeholder="输入地块简称"></el-input>
                            </el-col>
                        </el-form-item>
                        <el-form-item v-if="showJm">
                            <el-col :span="2" style="text-align: right">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="hs" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.hs" size="small" style="width:206px;" placeholder="输入户数"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>设计范围&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-input v-model="filters.sjfw" size="small" style="width:557px;" placeholder="输入设计范围"></el-input>
                            </el-col>
                        </el-form-item>
                        <el-form-item v-if="showJm">
                            <el-col :span="2" style="text-align: right">
                            ...
                            <el-col :span="5">
                                <el-input v-model="filters.dylh" size="small" style="width:206px;" placeholder="输入单元楼号"></el-input>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>规划泵房数&nbsp;&nbsp;</span>
                            </el-col>
                            <el-col :span="5">
                                <el-form-item prop="ghbfs" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.ghbfs" size="small" style="width:206px;" placeholder="输入规划泵房数"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>交房时间&nbsp;&nbsp;</span>
                        ...
                        <el-form-item v-if="showJm">
                            ...
                            <el-col :span="5">
                                <el-input v-model="filters.fqqk" size="small" style="width:206px;" placeholder="输入分期情况"></el-input>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>房屋性质&nbsp;&nbsp;</span>
                            </el-col>
                        ...
                        <el-form-item v-if="showGs">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="yxjbsl" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.yxjbsl" size="small" style="width:206px;" placeholder="输入意向接表数量"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>接水用途&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-input v-model="filters.jsyt" size="small" style="width:206px;" placeholder="输入接水用途"></el-input>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>用户性质&nbsp;&nbsp;</span>
                            </el-col>
                        ...
                        <el-form-item v-if="showHg">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="lfds" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.lfds" size="small" style="width:206px;" placeholder="输入楼房栋数"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>楼房户数&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-form-item prop="lfhs" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.lfhs" size="small" style="width:206px;" placeholder="输入楼房户数"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>平房户数&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-form-item prop="pfhs" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.pfhs" size="small" style="width:206px;" placeholder="输入平房户数"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-form-item>
                        <el-form-item v-if="showHg">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="zgcs" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.zgcs" size="small" style="width:206px;" placeholder="输入最高层数（层）"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>内部消防&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-form-item prop="ckys" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.ckys" size="small" style="width:206px;" placeholder="输入车库用水（间）"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-form-item>
                        <el-form-item v-if="showHg">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="cpys" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.cpys" size="small" style="width:206px;" placeholder="输入自行车棚用水（个）"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>门面用水&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-form-item prop="mmys" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.mmys" size="small" style="width:206px;" placeholder="输入经营门面用水（户）"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>公厕用水&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-form-item prop="gcys" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.gcys" size="small" style="width:206px;" placeholder="输入公厕用水（所）"></el-input>
                                </el-form-item>
                            </el-col>
                        </el-form-item>
                        <el-form-item v-if="showHg">
                            ...
                            <el-col :span="5">
                                <el-form-item prop="wgys" :rules="this.publicUtil.NullOrInteger">
                                    <el-input v-model="filters.wgys" size="small" style="width:206px;" placeholder="输入物管办公房用水（处）"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>其他用水&nbsp;&nbsp;</span>
                            ...
                            <el-col :span="5">
                                <el-input v-model="filters.qtys" size="small" style="width:206px;" placeholder="输入其他用水"></el-input>
                            </el-col>
                            <el-col :span="2" style="text-align: right">
                                <span>小区名称&nbsp;&nbsp;</span>
                            </el-col>
                        ...
                        <el-tab-pane label="原总表信息表" name="原总表信息表">
                            ...
                            <el-table :data="yzbxx" highlight-current-row v-loading="yzblistLoading" style="width: 100%;">
                                ...
                                <el-table-column label="操作" width="150" align="center">
                                    <template slot-scope="scope">
                                        <label title="编辑">
                                            <i class="iconfont icon-ai-edit"  @click="yzbhandleEdit(scope.$index, scope.row)"
                                               style="cursor:pointer;padding: 2px;color: #66b1ff"></i>
                                        </label>
                                        <label title="删除">
            ...
            <el-col :span=24>
                ...
                <el-row style="text-align: center;margin-top: 25px;">
                    ...
                    <el-button size="mini" type="primary" @click="slzp_vue">
                        <i class="iconfont icon-shenhetongguorenyuan"></i>受理指派</el-button>
...
<script>
    ...
    import { saveSld,getSclx,queryZlcount,queryUser,getScwj,addLdxx,editLdxx,getLdxxList,remove,importFile,
        getYzbList,yzbremove,addYzb,editYzb,toZpry,toDetial,deleteFj,download,saveImageToFj,getHyflCodeData,
        addGsbjxx,getGsbjxxList,editGsbjxx,gsremove} from '../../api/xqsl';
    ...
    export default {
        ...
        methods: {
            ...
            //跳转至项目全景
            goxmqj(){
                this.$router.push({path:'/Xmlct', query:{ xmid:this.updateId  }})
            },
            //工商报建信息新增
            gshandleAdds(){
            ...
            showMsg:function(data){//存储子组件保存的图片名称
                ...
                let params = {sqlx:this.sqid,operation:this.zlType,dirName:this.dirName,
                    fileName:data,sldid:this.updateId};
            ...
            queryinit:function(type){
                ...
                if(type == 1){
                    ...
                    this.filters.sqlx = params.typeid;
                    this.filters.sqdlx = params.type;
                    ...
                    if(params.typeid == '10'){
                        ...
                        this.filters.jfsj = params.xjfsj;
                        ...
                        this.filters.nbxf = params.nbxf == null ? '' : ''+params.nbxf;
            ...
            addSubmit(){
                this.$refs.addForm.validate((valid) => {
                    if (valid) {
                        ...
                        let para = Object.assign({sqlx:this.filters.sqlx,sqid:this.updateId}, this.addForm);
            ...
            yzbaddSubmit(){
                this.$refs.yzbaddForm.validate((valid) => {
                    if (valid) {
                        ...
                        let para = Object.assign({sqlx:this.filters.sqlx,sqid:this.updateId}, this.yzbaddForm);
            ...
            editSubmit: function () {
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ...
                        let para = Object.assign({sqlx:this.filters.sqlx}, this.editForm);
            ...
            yzbeditSubmit: function () {
                this.$refs.yzbeditForm.validate((valid) => {
                    if (valid) {
                        ...
                        let para = Object.assign({sqlx:this.filters.sqlx}, this.yzbeditForm);
