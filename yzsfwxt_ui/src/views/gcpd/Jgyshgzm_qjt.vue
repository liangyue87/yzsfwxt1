		...
		<el-row>
			<el-col :span="24">
				<el-card class="box-card">
					...
					<el-button size="mini" type="primary" @click="bc('0')" style="margin-left: 10px" v-if="xs != '1'"><i class="iconfont icon-save"></i>保存</el-button>
	...
	export default {
		data() {
			return {
				...
				xs:this.$route.query.type, //上个页面传来的项目信息
				filters: {
					xmmc: '',
					ysfw:'',
					jsdw:'',
