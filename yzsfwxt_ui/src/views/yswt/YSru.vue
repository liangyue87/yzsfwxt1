<template>
	<section>
		...
		<el-col :span="24" class="toolbar">
			...
			<el-table :data="yszp" fit style="width: 100%" highlight-current-row height="400px" stripe="true" :row-style="rowClass" :header-cell-style="{fontSize:'15px',background:'#f5f7fa' }">
				<el-table-column
					fixed
					property="xmbh"
					label="项目编号"
				...
				<el-table-column property="dwmc" label="单位名称" width="100"></el-table-column>
				...
				<el-table-column fixed="right" label="操作" width="100">
					<template  slot-scope="scope">
						...
						<el-button size="small" type="primary" @click="toFqlhkc(scope.row)">指派人员</el-button>
