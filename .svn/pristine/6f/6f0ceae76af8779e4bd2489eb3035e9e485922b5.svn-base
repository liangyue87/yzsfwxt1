                    ...
                    <div class="text item" v-if="sgdwbody">
                        <el-form :model="sgdwFk" label-width="150px" ref="xmxxForm" >
                            <el-form-item label="">
                                <el-row>
                                    <el-col :span="4">
                                        <el-checkbox v-model="sgdwFk.sfycgc" true-label="1" false-label="0" disabled>超高层</el-checkbox>
                                    </el-col>
                                    <el-col :span="10">
                                        <el-form-item label="">
                                            泵房供水位置
                            ...
                            <el-form-item label="">
                                <el-row>
                                    <el-col :span="4">
                                        <el-checkbox v-model="sgdwFk.sfyldsx" true-label="1" false-label="0" disabled>楼顶水箱</el-checkbox>
                                    </el-col>
                            ...
                            <el-form-item label="">
                                <el-row>
                                    <el-col :span="4">
                                        <el-checkbox v-model="sgdwFk.sfxydllhpf" true-label="1" false-label="0" disabled>道路绿化破复</el-checkbox>
                                    </el-col>
                                    <el-col :span="4">
                                        <el-checkbox v-model="sgdwFk.sfxypzdb" true-label="1" false-label="0" disabled>需要配置地表</el-checkbox>
                                    </el-col>
                                </el-row>
                            </el-form-item>
                            <el-form-item label="">
                                <el-row>
                                    <el-col :span="4">
                                        <el-radio v-model="sgdwFk.sfhykjbylzg" label="1" false-label="0" disabled>有</el-radio>
                                        <el-radio v-model="sgdwFk.sfhykjbylzg" label="0" false-label="0" disabled>否</el-radio>
                                    </el-col>
                                    <el-col :span="10">
                                        有可接表预留支管(若有在备注里说明)；
                                    </el-col>
                            ...
                            <el-form-item label="">
                                <el-row>
                                    <el-col :span="4">
                                        <el-radio v-model="sgdwFk.sfxybqg" label="1" false-label="0" disabled>有</el-radio>
                                        <el-radio v-model="sgdwFk.sfxybqg" label="0" false-label="0" disabled>否</el-radio>
                                    </el-col>
                                    <el-col :span="20">
                            ...
                            <el-form-item label="">
                                <el-row>
                                    <el-col :span="4">
                                        <el-radio v-model="sgdwFk.sfxyzglg" label="1" false-label="0" disabled>有</el-radio>
                                        <el-radio v-model="sgdwFk.sfxyzglg" label="0" false-label="0" disabled>否</el-radio>
                                    </el-col>
                                    <el-col :span="20">
...
<script>
    import { getFkpjKcbm,download } from '../../api/xkylx';
    ...
    export default {
        ...
        methods: {
            ...
            getKcbm(){//参与勘查的部门以及反馈信息
                let params = { xmid: this.xmid, kczt:''};
