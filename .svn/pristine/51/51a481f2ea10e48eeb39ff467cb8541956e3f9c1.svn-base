		...
		<el-row>
			...
			<el-col :span="24" class="toolbar" style="border: 1px solid #f5f7fa;">
				<el-form  :model="filters" style="margin-top: 10px" size="small">
					<el-form-item>
						...
						<el-col :span="5">
							<el-input v-model="filters.dwmc" @keyup.enter.native="findOriginate"></el-input>
						</el-col>
						<el-col :span="2" style="text-align: right">
							<span>任务编号&nbsp;</span>
						</el-col>
						<el-col :span="5">
							<el-input v-model="filters.rwbh" @keyup.enter.native="findOriginate"></el-input>
						</el-col>
						<el-col :span="2" style="text-align: right">
							<span>任务类别&nbsp;</span>
						</el-col>
					...
					<el-form-item>
						...
						<el-col :span="3" style="text-align: left">
							<el-button size="mini" type="primary" @click="findOriginate"><i class="iconfont icon-chaxun"></i>查询</el-button>
						</el-col>
					</el-form-item>
				</el-form>
			</el-col>
			<el-col :span="24" class="toolbar">
				...
				<el-table :data="row" border highlight-current-row v-loading="listLoading" style="width: 100%;"
					...
					<el-table-column property="JSR" label="接收人"  width="100" align="center">
					</el-table-column>
...
<script>
	...
	import { findOriginate,getTypeCheckbox } from '../../api/work';
	export default {
		data() {
			return {
				filters: {
