    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item>
                    <el-button type="primary" v-on:click="getTftzd_vue">查询</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        ...
        <el-table :data="rows" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="ytje" label="应退金额" width="100"  sortable>
            </el-table-column>
            <el-table-column prop="stje" label="实退金额" width="100"  sortable>
            </el-table-column>
            <el-table-column prop="qrsj" label="确认时间" width="200" >
            </el-table-column>
            <el-table-column prop="sjh" label="收据号" width="150" >
            </el-table-column>
...
<script>
    ...
    import {getTftzd} from '../../api/tftzdlb';
    export default {
        data() {
            return {
                filters: {
