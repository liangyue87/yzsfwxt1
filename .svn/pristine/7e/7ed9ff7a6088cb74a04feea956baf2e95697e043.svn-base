        ...
        <el-row>
            <el-col :span="24">
                        ...
                        <el-form :model="sgdwFk" label-width="150px" ref="xmxxForm" >
                            <el-form-item label="">
                                <el-row>
                                    ...
                                    <el-col :span="10">
                                        <el-form-item label="泵房供水位置">
                                            <el-input type="text" v-model="sgdwFk.bfgswz" readonly></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                            </el-form-item>
                            <el-form-item label="">
                                <el-row>
                                    ...
                                    <el-col :span="10" style="text-align: left;">
                                        <el-form-item label="楼顶水箱位置">
                                            <el-input type="text" v-model="sgdwFk.ldsxwz" readonly></el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                            </el-form-item>
                ...
                <el-card class="box-card"  style="margin-top: 15px;width: 100%">
                    <div slot="header" class="clearfix">
                        <div class="div_title">联合勘查项目经理反馈
                            ...
                            <el-col :span="20">
                                <el-form label-width="150px" :model="kcpj" ref="kcpj" >
                                    <el-form-item label="实际勘查日期" style="width: 45%" prop="sjkcsj">
                                        <el-date-picker v-model="kcpj.sjkcsj" type="date" placeholder="选择日期"
                ...
                <!--设计审图管网反馈-->
                <el-card class="box-card"  style="margin-top: 15px;" v-if="gwfk">
                    <div slot="header" class="clearfix">
                        <div class="div_title">
                            设计审图管网反馈
                            <span class="span_cz" @click="openBody('6')" v-if="!gwfkbody"><i class="el-icon-caret-right">点击展开</i></span>
                            <span class="span_cz" @click="closeBody('6')" v-if="gwfkbody"><i class="el-icon-caret-bottom">点击收起</i></span>
                        </div>

                    </div>
                   <div class="text item" v-if="gwfkbody">
                        <el-table :data="gwFk" border style="width: 100%;margin-top: 10px;">
                            <el-table-column type="expand">
                                <template slot-scope="props">
                                    <el-form label-position="left" label-width="100px" inline class="demo-table-expand">
                                     <!--   <el-form-item label="商品名称">
...
<!--
                        <el-card class="box-card"  style="margin-top: 20px;">
                            <span>资料附件</span>
                            <div class="text item">
                                <el-table :data="gwFj" border style="width: 100%;">
                                    <el-table-column type="index" label="序号" width="80" align="center">
                                    </el-table-column>
                                    <el-table-column property="fjmc" label="附件名称" width="200" align="center">
                                    </el-table-column>
                      ...
                      <!--  <el-row style="margin-top: 20px;">
                            <el-col :span="24">
                                <el-form>
                                    <el-form-item label="管网反馈反馈意见" style="width: 100%">
                                        <el-input type="textarea" v-model="gwFkyj" readonly></el-input>
                                    </el-form-item>
                                </el-form>
                            </el-col>
                        </el-row>-->
