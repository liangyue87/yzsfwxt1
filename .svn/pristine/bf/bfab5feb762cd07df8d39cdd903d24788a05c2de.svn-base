...
@Entity
@Table(name = "GET_XMLB_ZJQT")
public class GetXmlbEntity {
    private String id;
    ...
    @Transient
    private String sfzjqt;

    public String getSfzjqt() {
        return sfzjqt;
    }

    public void setSfzjqt(String sfzjqt) {
        this.sfzjqt = sfzjqt;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetXmlbEntity that = (GetXmlbEntity) o;
        return iszj == that.iszj &&
                Objects.equals(id, that.id) &&
                Objects.equals(pxmid, that.pxmid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, pxmid, xmbh, sqlx, azlx, slid, sqbh, xmlb, xmtzf, xmswlxfl, qbid, status, slrbh, lxsj, xmfzr, xmmc, lxr, lxrsjh, xmdz, dwmc, slsj, iszj, lxdh, xzqybh, zjzmj, sjfzr, stfzr, jlfzr, zjfzr, ysfzr, qsfzr, sgfzr, bz, bmbmQs, jhkssj, jhjssj, xmdzSheng, xmdzShi, xmdzXzqybh, slsjStr, first, procStatus, pdefId);
    }
}
