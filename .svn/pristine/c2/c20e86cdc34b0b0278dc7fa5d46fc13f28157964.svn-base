        ...
        <el-row>
            ...
            <el-col :span="24" class="toolbar" style="border: #f5f7fa solid 1px">
                <el-form  :model="filters" >
                    <el-form-item>
                        ...
                        <el-col :span="5">
                            <el-select v-model="filters.qszt"clearable  placeholder="请选择" style="width:100%" size="small ">
            ...
            <el-col :span="24" class="toolbar" >
                ...
                <el-table :data="row"  v-loading="listLoading" style="width: 100%;" height="500px" :row-style="rowClass" :header-cell-style="{fontSize:'15px',background:'#f5f7fa' }">
                    ...
                    <el-table-column prop="qszt" label="项目状态" width="150" align="center">
                    </el-table-column>
                    <el-table-column prop="azlx" label="安装类型" width="150" align="center">
                    </el-table-column>
                    <el-table-column prop="lxr" label="用户联系人" width="150" align="center">
                    </el-table-column>
                    <el-table-column prop="lxsj" label="立项时间" width="200" align="center" >
                    </el-table-column>
                    ...
                    <el-table-column label="操作" width="150" align="center" fixed="right">
                        <template slot-scope="scope">
                            <label title="发起审核" @click="handleEdit(scope.$index, scope.row)">
...
<script>
    ...
    import{getJssqCsLsit}from'../../api/Js';
    export default {
        data(){
            return{
                filters:{
        ...
        methods:{
            ...
            handleEdit: function (index, row) {
                this.$router.push({path: '/JssqCslbsj',  query: {xmid : row.ID,sqlx:row.sqlx,sqbh:row.sqbh}})
