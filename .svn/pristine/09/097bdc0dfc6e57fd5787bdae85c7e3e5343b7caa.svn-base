...
@Entity
@Table(name = "YWSL_XJXQSQB_FJ")
public class YwslXjxqsqbFjEntity {
    private String id;
    private String ywslXjxqsqbid;
    ...
    @Basic
    @Column(name = "YWSL_XJXQSQBID")
    public String getYwslXjxqsqbid() {
        return ywslXjxqsqbid;
    }

    public void setYwslXjxqsqbid(String ywslXjxqsqbid) {
        this.ywslXjxqsqbid = ywslXjxqsqbid;
    }
    ...
    public boolean equals(Object o) {
        ...
        YwslXjxqsqbFjEntity that = (YwslXjxqsqbFjEntity) o;
        return Objects.equals(id, that.id) &&
                Objects.equals(ywslXjxqsqbid, that.ywslXjxqsqbid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, ywslXjxqsqbid, fjlxYj, fjlxEj, fjlj, fjhz, fjmc, scr, scsj, scFlag, shcr, shcsj);
    }
}
