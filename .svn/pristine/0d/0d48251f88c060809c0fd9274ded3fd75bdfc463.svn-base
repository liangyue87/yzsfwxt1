				...
				<el-form  :model="filters" >
					...
					<el-form-item>
						...
						<el-col :span="3" style="text-align: center">
							<el-button type="primary" @click="getXckcZpTask">查询</el-button>
						</el-col>
					</el-form-item>
				</el-form>
			</el-col>
...
<script>
	...
	export default {
		...
		methods: {
			//获取勘查任务
			getXckcZpTask() {
				let params = Object.assign({ type: '2',page: this.page, size: this .size }, this.filters);
			...
			toZpry: function (index, row) {
				...
				this.$router.push({path: '/Rwzpsgdw', query: {xmid : row.id}})
				//});
