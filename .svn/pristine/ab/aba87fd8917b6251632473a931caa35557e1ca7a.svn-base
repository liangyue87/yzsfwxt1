...
<template>
	<section>
			...
			<el-card  class="box-card"  style="margin-top: 15px;">
				...
				<div class="text item">
					<el-tabs v-model="activeName" type="card" >
						...
						<el-tab-pane label="物料清单配置" name="2"><wlqdpz :qb="1" :xmid="xmid" v-if="activeName=='2'" :name="1"></wlqdpz></el-tab-pane>
		...
		<YSCG :zbid="Ysfrom.zbid" :xmid="xmid" :xmbh="Ysfrom.xmbh" :type="'1'"></YSCG>
		...
		<el-row>
			<el-col :span="24">
				<el-card class="box-card">
					...
					<el-button size="mini" type="primary" @click="submitForm()" style="margin-left: 10px" :loading="sumbitLoading"><i class="iconfont icon-queren"></i>提交审核</el-button>
					...
					<!--<el-button size="mini" type="primary" @click="goxmzl()" :loading="sumbitLoading" v-if="1!=1"><i class="iconfont icon-ziliaoquanjiing_"></i>项目资料</el-button>-->
				</el-card>
			</el-col>
		</el-row>
