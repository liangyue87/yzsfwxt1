...
@Entity
@Table(name = "GET_XMLB_JF")
public class GetXmlbJfEntity {
    private String id;
    ...
    public String getVazlx() {
        return vazlx;
    }

    public void setVazlx(String vazlx) {
        this.vazlx = vazlx;
    }
    ...
    public boolean equals(Object o) {
        ...
        GetXmlbJfEntity that = (GetXmlbJfEntity) o;
        return iszj == that.iszj &&
                ...
                Objects.equals(xmdz_xzqybh, that.xmdz_xzqybh) &&
                ...
                Objects.equals(vazlx, that.vazlx);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, pxmbh, xmbh, sqlx, azlx, slid, sqbh, xmlb, xmtzf, xmswlxfl, qbid, status, slrbh, lxsj, xmfzr, xmmc, lxr, lxrsjh, xmdz, dwmc, slsj, iszj, lxdh, xzqybh, zjzmj, sjfzr, stfzr, jlfzr, zjfzr, ysfzr, qsfzr, sgfzr, bz, bmbmQs, jhkssj, jhjssj, xmdzSheng, xmdzShi, xmdz_xzqybh, slsjStr, first, procStatus, pdefId, username, vazlx);
    }
}
