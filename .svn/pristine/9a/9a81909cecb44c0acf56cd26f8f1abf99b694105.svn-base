...
@Entity
@Table(name = "YWSL_GSHBSQB_FJ")
public class YwslGshbsqbFjEntity {
    private String id;
    private String ywslGshbsqbid;
    ...
    @Basic
    @Column(name = "YWSL_GSHBSQBID")
    public String getYwslGshbsqbid() {
        return ywslGshbsqbid;
    }

    public void setYwslGshbsqbid(String ywslGshbsqbid) {
        this.ywslGshbsqbid = ywslGshbsqbid;
    }
    ...
    public boolean equals(Object o) {
        ...
        YwslGshbsqbFjEntity that = (YwslGshbsqbFjEntity) o;
        return Objects.equals(id, that.id) &&
                Objects.equals(ywslGshbsqbid, that.ywslGshbsqbid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, ywslGshbsqbid, fjlxYj, fjlxEj, fjlj, fjhz, fjmc, scr, scsj, scFlag, shcr, shcsj);
    }
}
