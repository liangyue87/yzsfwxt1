...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initView() {
                let html = "";
                html = '<div class="window rank_three line_three " id="A0001">工程合格评定</div>';
                                    ...
                                    $(id).click(function () {
                                        if (id == "#A0001") {
                                            ...
                                            getSqgcHgpdList(params).then(res => {
                                                this.gcHgpd = res.data.gcHgpd[0];
                                                _this.$router.push({path: '/Jgyshgzm_qjt',query:{ tow1:this.gcHgpd,type:'1' }})
                                            });
                                        }
                                    });
