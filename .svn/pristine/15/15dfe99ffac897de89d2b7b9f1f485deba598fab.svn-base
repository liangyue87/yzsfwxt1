	...
	<section>
		<el-form  :model="gclgdzjForm" >
				...
				<el-form-item>
					...
					<el-col :span="21">
						<el-input v-model="gclgdzjForm.lm" readonly size="small"></el-input>
					</el-col>
				</el-form-item>
				<el-form-item>
					<el-col :span="3" style="text-align: right">
					...
					<el-col :span="5">
						<el-input readonly v-model="gclgdzjForm.ldbh" size="small" ></el-input>
					</el-col>
					<el-col :span="4">
                        <el-row>
                            <el-col :span="12">
				...
				<el-form-item>
					...
					<el-col :span="9">
						<el-date-picker size="small" value-format="yyyy-MM-dd" format="yyyy-MM-dd" :editable="false" readonly type="date" placeholder="选择日期" v-model="gclgdzjForm.azrq_vue" style="width: 100%"></el-date-picker>
					</el-col>
					<!-- <el-col :span="3" style="text-align: right">
						<span>填表日期：</span>
					</el-col>
					...
					<el-col :span="9">
						<el-input v-model="gclgdzjForm.htr" readonly size="small"></el-input>
					</el-col>
				</el-form-item>
				<el-form-item>
                    <!-- <el-col :span="3" style="text-align: right">
