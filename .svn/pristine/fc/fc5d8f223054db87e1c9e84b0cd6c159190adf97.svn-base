            ...
            <el-col :span="24">
                            ...
                            <el-col :span="14">
                                <table class="border-table">
                                    ...
                                    <tr style="text-align: center">
                                        ...
                                        <td>{{sgzl}}</td>
                                        <td> <label title="查看">
                                            <i class="iconfont icon-yulan"  @click="getSgZl()" style="cursor:pointer;padding: 2px;color: #66b1ff"></i>
                                        </label></td>
                                      <!--  <td title="查看" @click="getSgZl()" style="color: #00a65a"><i class="iconfont icon-tiaocha"></i></td>-->
                                    </tr>
                                    <tr style="text-align: center">
                                        <td>设计成果</td>
                                        <td>{{sjcg}}</td>
                                        <td> <label title="查看">
                                            <i class="iconfont icon-yulan"  @click="getSjcg()" style="cursor:pointer;padding: 2px;color: #66b1ff"></i>
                                        </label></td>
                                       <!-- <td title="查看" @click="getSjcg()" style="color: #00a65a"><i class="iconfont icon-tiaocha"></i></td>-->
                                    </tr>
                                    <tr style="text-align: center">
                                        <td>客户提供资料</td>
                                        <td>{{khzl}}</td>
                                        <td> <label title="查看">
                                            <i class="iconfont icon-yulan"  @click="getKhtgzl()" style="cursor:pointer;padding: 2px;color: #66b1ff"></i>
                                        </label></td>
                                      <!--  <td title="查看" @click="getKhtgzl()" style="color: #00a65a"><i class="iconfont icon-tiaocha"></i></td>-->
                                    </tr>
                                </table>
                            </el-col>
                        </el-row>
                ...
                <el-row style="margin-top: 30px;">
                    ...
                    <el-col :span="12">
                        ...
                        <el-button size="mini" type="primary" @click="tijiao()" :loading="sumbitLoading"><i class="iconfont icon-queren"></i>提交</el-button>
                           ...
                           <!-- <el-table-column property="nameSter" label="附件类型" width="150"></el-table-column>-->
                            ...
                            <el-table-column label="操作" width="100">
                                <template slot-scope="scope">
                                    <el-button size="mini" type="success" @click="zlfl_download(scope.$index, scope.row)"><i class="iconfont icon-xiazai_f"></i>下载</el-button>
                                 <!--   <el-button size="small" type="primary" @click="zlfl_download(scope.$index, scope.row)">下载</el-button>-->
                                </template>
                            </el-table-column>
                        </el-table>
...
<script>
    ...
    import YSHZB from '@/views/template/yshzb.vue';
    import util from '../../common/js/util'
    import {selectZlflsl,download} from '../../api/zhys'
    import {SaveYhjssq} from '../../api/Js'
