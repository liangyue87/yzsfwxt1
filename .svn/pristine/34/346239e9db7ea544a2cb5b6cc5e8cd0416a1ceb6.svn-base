<template>
	<section>
		...
		<el-col :span="24" class="toolbar">
			<!-- 查询结果  -->
			<el-table :data="ysqs" fit style="width: 100%" highlight-current-row height="400px" stripe="true" :row-style="rowClass" :header-cell-style="{fontSize:'15px',background:'#f5f7fa' }">
